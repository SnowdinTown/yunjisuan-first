...
f = open('elasticsearch.csv', mode='a', encoding='utf-8', newline='')
csv_writer = csv.writer(f)

for page in range(0, 1000):
    print(f'-------------------正在抓取第{page}页-----------------')
    url = f"https://github.com/elastic/elasticsearch/commits/main?after=b9bb7252be68fa9fb5146d3b4c88fd41cfcb7a7b+{page*35+34}&branch=main&qualified_name=refs%2Fheads%2Fmain"
